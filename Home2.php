            ...
            <div class="row">
               ...
               <div class=" col-md-6 col-sm-6">
                  <ul class="conat_info d_none ">
                     ...
                     <?php if (isset($user)): ?>
                        <li><a href="reservation_status.php">
   ...
   <section class="banner_main bottom_cross">
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-7">
               <div class="ban_car">
                  <figure><img src="cars/Civic.png" alt="#" /></figure>
               </div>
            </div>
            <div class="col-md-5">
               <div class="text-bg">
         ...
         <div class="row ">
            ...
            <div class="col-md-7">
               <div class="about_right">
                  <figure><img src="cars/Montero.png" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  ...
                  <p>Presenting you our for rental vehicles that is safe, comfortable, and road worthy.<br></p>
               </div>
            </div>
         </div>
      </div>
   ...
   <div id="luxury" class="luxury bottom_cross6">
      <div class="container-fluid">
         ...
         <div class="row d_flex">
               ...
               <div class="form_date">
                  <form method="POST">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <input type="submit" class="tinueCar" name="reserve" value="Confirm">
                        </div>
                     </div>
                  </form>
               </div>
            ...
            <div class="col-lg-6 col-md-12">
               <div class="ban_car">
                  <figure><img src="cars/BR-V.png" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
